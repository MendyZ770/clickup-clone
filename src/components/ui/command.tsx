...
const CommandDialog = ({ children, ...props }: CommandDialogProps) => {
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 sm:p-0 shadow-2xl">
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-border/20 px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-14 w-full rounded-none bg-transparent py-3 text-sm outline-none focus:ring-0 focus:outline-none focus:border-none border-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
